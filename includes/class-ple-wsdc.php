...
class Ple_Wsdc {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Ple_Wsdc_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Ple_Wsdc_Loader. Orchestrates the hooks of the plugin.
	 * - Ple_Wsdc_i18n. Defines internationalization functionality.
	 * - Ple_Wsdc_Admin. Defines all hooks for the admin area.
	 * - Ple_Wsdc_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Ple_Wsdc_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Ple_Wsdc_Loader    Orchestrates the hooks of the plugin.
	 */
